...
internal enum L10n {
  ...
  /// Export Outline
  internal static let exportMarkdownOutline = L10n.tr("Localizable", "Export_Markdown_Outline")
  /// Export Post
  internal static let exportMarkdownPost = L10n.tr("Localizable", "Export_Markdown_Post")
  /// Export OPML
