//
//  RowIndentTableViewController.swift
//  Zavala
//
...
class RowIndentTableViewController: UITableViewController {
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		if size == AppDefaults.shared.rowIndentSize {
	...
	override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		if let colorPalette = DefaultsSize(rawValue: indexPath.row) {
			AppDefaults.shared.rowIndentSize = colorPalette
		}
