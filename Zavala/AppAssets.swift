...
extension String {
	...
	static let importHTMLControlLabel = String(localized: "button.text.import-html", comment: "Action: Import HTML")
	static let importHTMLEllipsisControlLabel = String(localized: "button.text.import-html-with-ellipsis", comment: "Action: Import HTML…")
