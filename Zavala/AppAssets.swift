...
extension String {
	...
	static var addNoteLevelControlLabel = String(localized: "Add Note Level", comment: "Control Label: Add Note Level")
	...
	static var deleteTagMessage = String(localized: "Any child Tag associated with this Tag will also be deleted. No Outlines associated with this Tag will be deleted.", comment: "Alert Message: delete tag")
	static var deleteTagsMessage = String(localized: "Any child Tag associated with these Tags will also be deleted. No Outlines associated with these Tags will be deleted.", comment: "Alert Message: delete tags")
