...
final class PreferencesControlsBackgroundView: NSView {
	...
	override func draw(_ dirtyRect: NSRect) {
		let fillColor = self.effectiveAppearance.bestMatch(from: [.darkAqua, .aqua]) == .darkAqua ? darkModeFillColor : lightModeFillColor
		fillColor.setFill()
		dirtyRect.fill()

		let borderColor = self.effectiveAppearance.bestMatch(from: [.darkAqua, .aqua]) == .darkAqua ? darkModeBorderColor : lightModeBorderColor
		borderColor.set()
